...
echo "$($PSQL "SELECT name FROM teams INNER JOIN games ON teams.team_id=games.winner_id WHERE
games.year=2018 AND games.round='Final' AND teams.team_id=games.winner_id;")"
...
echo "$($PSQL "SELECT year, name FROM teams INNER JOIN games ON teams.team_id=games.winner_id WHERE
(games.year=2018 OR games.year=2014) AND games.round='Final' AND teams.team_id=games.winner_id ORDER BY name DESC")"
